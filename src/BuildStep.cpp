...
/*
        {
                ...
                //terran
                {"refinery", BuildStepType::CONSTRUCT},
                ...
                {"fusion_core", BuildStepType::CONSTRUCT},
                {"viking", BuildStepType::PRODUCE},
                {"medivac", BuildStepType::PRODUCE},
                {"siege_tank", BuildStepType::PRODUCE},
                {"thor", BuildStepType::PRODUCE},
                {"armory", BuildStepType::CONSTRUCT},
                {"orbital_command", BuildStepType::CONSTRUCT}, //and update?
                {"command_center", BuildStepType::CONSTRUCT},
                {"scv", BuildStepType::PRODUCE},
                {"engineering_bay", BuildStepType::CONSTRUCT},
                {"planetary_fortress", BuildStepType::CONSTRUCT}, // and update?
