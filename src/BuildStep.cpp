...
map<string, BuildStepType> BuildStep::stringToBuildStepType =
        {
                ...
                //zerg
                {"hatchery", BuildStepType::CONSTRUCT},
                {"larva", BuildStepType::PRODUCE},
                {"evolution_chamber", BuildStepType::CONSTRUCT},
                {"crawler", BuildStepType::PRODUCE},
                {"drone", BuildStepType::CONSTRUCT},
                {"queen", BuildStepType::PRODUCE},
                {"lair", BuildStepType::UPGRADE},
                {"overseer", BuildStepType::UPGRADE},
                {"overlord", BuildStepType::CONSTRUCT},
                {"spwaning_pool", BuildStepType::CONSTRUCT},
                {"spine_crawler", BuildStepType::CONSTRUCT},
                {"roach_warren", BuildStepType::CONSTRUCT},
                {"baneling_nest", BuildStepType::CONSTRUCT},
                {"extractor", BuildStepType::CONSTRUCT},
                {"zergling", BuildStepType::PRODUCE},
                {"roach", BuildStepType::PRODUCE},
                {"baneling", BuildStepType::PRODUCE}, //and upgrade?
                {"infestation_pit", BuildStepType::CONSTRUCT},
                {"infestor", BuildStepType::PRODUCE},
                {"hive", BuildStepType::CONSTRUCT},
                {"spire", BuildStepType::CONSTRUCT},
                {"greater_spire", BuildStepType::CONSTRUCT},//and upgrade?
                {"corruptor", BuildStepType::PRODUCE },
                {"mutalisk", BuildStepType::PRODUCE},
                {"brood_lord", BuildStepType::PRODUCE}, //and upgrade?
                {"ultralisk_cavern", BuildStepType::CONSTRUCT},
                {"ultralisk", BuildStepType::PRODUCE},
                {"nydus_worm", BuildStepType::PRODUCE},
                {"nydus_network", BuildStepType::PRODUCE},
                {"hydralisk_den", BuildStepType::CONSTRUCT},
